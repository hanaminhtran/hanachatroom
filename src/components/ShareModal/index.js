...
class ShareModal extends Component {
  ...
  _copyShareLink = () => {
    ...
    notification('You have copied the invitation link, you can send it to people outside the app', 'success');
  };
    ...
    return (
      ...
      >
        ...
        <div className="shareShareLink" onClick={this._copyShareLink}>
          ...
          Copy the link and share it with people outside the app
        </div>
      </Modal>
    );
  }
