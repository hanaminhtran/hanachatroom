...
function getPlaceholder(isRobotChat) {
  switch (true) {
    case /group_chat/.test(window.location.href):
      return 'Support Enter to send messages/paste and post pictures/@ other people';
    case isRobotChat:
      return 'Support Enter to send messages';
    default:
      return 'Support Enter to send messages/paste and post pictures';
  }
}
